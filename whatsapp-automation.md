{
  "nodes": [
    {
      ...
      "id": "e3e1ad16-b799-45f3-aea7-d255264b0b77",
    ...
    },
    {
      ...
      "id": "2123861c-fa4d-4542-bf4d-1141995121f9",
      "name": "Get Audio URL",
      ...
      "typeVersion": 1,
      "webhookId": "6f916839-4867-425b-b9c5-17722f9d5eca",
      "credentials": {
        "whatsAppApi": {
          "id": "Mlzl6gxpPd5CUCLc",
    ...
    },
    {
      ...
      "id": "56538577-9823-44be-a24c-0a6acfda87cf",
      "name": "Get Video URL",
      "type": "n8n-nodes-base.whatsApp",
      "position": [
        -760,
      ...
      "typeVersion": 1,
      "webhookId": "582812d2-1473-4bd5-8368-db48d945c619",
      "credentials": {
        "whatsAppApi": {
          "id": "Mlzl6gxpPd5CUCLc",
          "name": "WhatsApp account"
    ...
    },
    {
      ...
      "id": "7ae38e2f-ff70-4b82-b7e1-016c0ac79cf9",
      "name": "Get Image URL",
      "type": "n8n-nodes-base.whatsApp",
      "position": [
        -760,
      ...
      "typeVersion": 1,
      "webhookId": "2031fbf6-4bf1-4492-bd45-1bf6ca142304",
      "credentials": {
        "whatsAppApi": {
          "id": "Mlzl6gxpPd5CUCLc",
          "name": "WhatsApp account"
    ...
    },
    {
      ...
      "id": "bebf1647-55cf-4ab6-92f7-8fbe9d34cfcb",
      "name": "Download Video",
    ...
    },
    {
      ...
      "id": "28a59cde-bfbd-4fd0-9d64-97e2e957b9ab",
      "name": "Download Audio",
      "type": "n8n-nodes-base.httpRequest",
      "position": [
        -600,
    ...
    },
    {
      ...
      "id": "cd4ce9b6-c996-4961-8cd8-a4ea3084d80c",
      "name": "Download Image",
      "type": "n8n-nodes-base.httpRequest",
      "position": [
        -600,
    ...
    },
    {
      ...
      "id": "405ec287-46ba-4a27-a12f-be2cfac07079",
    ...
    },
    {
      ...
      "id": "743e1f96-7f3d-49da-b91b-41e6c0e439ef",
    ...
    },
    {
      ...
      "id": "6757488c-85ce-4585-aa90-b3f1a3cc0cd1",
    ...
    {
      "parameters": {},
      "id": "46229737-2bf1-4dbc-b10e-55d7061e0822",
      "name": "Wikipedia",
    ...
    },
    {
      ...
      "id": "c83eafa7-4eed-4ef9-beae-f9cfaacf6cfd",
    ...
    },
    {
      ...
      "id": "8226c41f-2181-4a9a-b8c6-455bca33eae3",
      "name": "Sticky Note",
    ...
    },
    {
      ...
      "id": "2786c49e-63b9-457d-a30f-7d56c280d405",
      "name": "Sticky Note1",
      "type": "n8n-nodes-base.stickyNote",
      "position": [
        -760,
    ...
    },
    {
      ...
      "id": "41afb288-e1a9-43ae-be42-4c384623019b",
      "name": "Sticky Note2",
      "type": "n8n-nodes-base.stickyNote",
      "position": [
        -760,
    ...
    },
    {
      ...
      "id": "d8fe5817-07ce-424a-a5bf-88593274f61a",
      "name": "Sticky Note3",
      "type": "n8n-nodes-base.stickyNote",
      "position": [
        -760,
    ...
    },
    {
      ...
      "id": "0ec7f9e2-3564-44ab-a77a-1f690649fd04",
      "name": "Sticky Note4",
      "type": "n8n-nodes-base.stickyNote",
      "position": [
        -760,
    ...
    },
    {
      ...
      "id": "a6b0709c-8c57-46d4-b33e-c457f6511ed9",
      "name": "Get Text",
    ...
    },
    {
      ...
      "id": "5eacbd33-e5e1-4daf-8fd4-449c45c0a6f3",
      "name": "Sticky Note5",
      "type": "n8n-nodes-base.stickyNote",
      "position": [
        500,
    ...
    },
    {
      ...
      "id": "17d0e397-c794-40c7-9c32-3c9d8d1d01d0",
      "name": "Sticky Note6",
      "type": "n8n-nodes-base.stickyNote",
      "position": [
        960,
    ...
    },
    {
      ...
      "id": "7ca997d0-18a9-46eb-844d-7fd388a1d5e5",
      ...
      "typeVersion": 1,
      "webhookId": "4aa98680-c6b1-48c4-8675-efcdb89979d6",
      "credentials": {
        "whatsAppApi": {
          "id": "Mlzl6gxpPd5CUCLc",
          "name": "WhatsApp account"
    ...
    },
    {
      ...
      "id": "b5b8c5f4-b368-40ed-9435-b3e0bd1fff87",
      "name": "Sticky Note7",
      "type": "n8n-nodes-base.stickyNote",
      "position": [
        -2120,
    ...
    },
    {
      ...
      "id": "798dc16c-1e2d-471a-a3e1-e3acc88011a4",
      "name": "Sticky Note8",
      "type": "n8n-nodes-base.stickyNote",
      "position": [
        -2120,
    ...
    },
    {
      ...
      "id": "72361198-db8f-46b8-9ff1-fa18f70ffd06",
    ...
    },
    {
      ...
      "id": "ca60088d-032b-4398-8ae6-f5b184af7fb1",
    ...
    },
    {
      ...
      "id": "1d38bb80-47f5-471d-8a1a-0615b522bbfe",
      "name": "Sticky Note9",
      "type": "n8n-nodes-base.stickyNote",
      "position": [
        -240,
    ...
    },
    {
      ...
      "id": "45aff017-0c0a-4b43-a29a-ad6635f81292",
    ...
    },
    {
      ...
      "id": "0fc5b9bf-54e5-42d1-a245-554bd700c0ee",
      "name": "Sticky Note10",
      "type": "n8n-nodes-base.stickyNote",
      "position": [
        -240,
    ...
    },
    {
      ...
      "id": "f3f1c367-f3f1-42ba-822a-69c40b0c7702",
    ...
    },
    {
      ...
      "id": "3bd39dad-ae29-4f4b-8a68-a3b3733b2c40",
    ...
    },
    {
      ...
      "id": "cbf14237-b26e-4f03-a799-dda9fb90339e",
    ...
    },
    {
      ...
      "id": "4713950d-80a3-4958-94fd-3729bd8df8a3",
    ...
    },
    {
      ...
      "id": "b719de6e-cbff-429b-8671-3c9a27331397",
    ...
    },
    {
      ...
      "id": "709e9013-163a-47ac-9689-90e900e7a52e",
    ...
    },
    {
      ...
      "id": "7aeabc7a-14c7-4949-b30c-7783b6c15c06",
      "name": "AI Agent",
  ...
  "meta": {
    ...
    "instanceId": "1f2508c3b8046a6c62208524c9fe0acd3157a32533a3f3dabd4664f47c419238"
  }
}
